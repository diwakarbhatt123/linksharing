...
<div class="content-container">
    ...
    <div class="context primary-text-color">
        ...
        <p>Check our status page for more information. Report a problem if you think we are unaware of the issue.</p>


    </div>
    <div class="buttons-container">
        <a class="border-button" href="/" target="_blank">Go Back</a>
    </div>
</div>
