                ...
                <div>
                    ...
                    <div class="col-xs-10">
                        ...
                        <div class="row" style="padding-bottom:10px">
                            ...
                            <div class="col-xs-2"><small><ls:isRead resourceId="${post.id}"/></small></div>

                            <div class="col-xs-2"><small><g:link controller="resource" action="show"
                                                                 id="${post.id}">View Post</g:link></small></div>
                        </div>
                    </div>
                </div>
            </g:each>
